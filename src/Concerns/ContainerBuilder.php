...
class ContainerBuilder extends NetteContainerBuilder
{
     ...
     *
     * @param string|array|Definition|Definitions\Reference|Definitions\Statement $class
     *
